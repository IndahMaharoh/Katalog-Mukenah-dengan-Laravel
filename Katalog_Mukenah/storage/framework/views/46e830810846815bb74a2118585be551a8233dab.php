...
<?php $__env->startSection('tampilan'); ?>
	...
	?>
        ...
        <fieldset style="margin-left: 8%; margin-right: 8%;">
            ...
            <form action="/kota/tambah" method="POST" style="margin-left: 10%;">
            <?php echo csrf_field(); ?>               
            <table>
                    <tr>
                        <td>Id Kota</td>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Katalog_Mukenah\resources\views/tambah.blade.php ENDPATH**/ ?>