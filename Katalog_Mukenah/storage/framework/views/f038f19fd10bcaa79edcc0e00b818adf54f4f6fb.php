...
<?php $__env->startSection('tampilan'); ?>
		...
		<td><a href="/rp/<?php echo e($r->produk_id); ?>/edit"><button>Edit</button></a>
        <a href="/rp/hapus/<?php echo e($r->produk_id); ?>" onclick="return confirm('Apakah Anda Yakin Menghapus Data?');"><button>Hapus</button></a>
	</td>
		</tr>
		<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</table>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Katalog_Mukenah\resources\views/harga.blade.php ENDPATH**/ ?>